...
Towards the end of my testing I added 1 test within test_models.py to test whether a record could sucessfully be added to the BookingTimes database, which it passes.
